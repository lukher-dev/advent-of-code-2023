...
func findEnd(data []string) int {
	...
	for {
		...
		if newNode[0] == -1 {
			return traversedNodes[nodesToExplore[0][0]][nodesToExplore[0][1]] + 1
		}
		traversedNodes[newNode[0]][newNode[1]] = traversedNodes[nodesToExplore[0][0]][nodesToExplore[0][1]] + 1
